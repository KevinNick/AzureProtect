...
{
    public partial class AzureProtectPage : System.Web.UI.Page
    {
        ...
        public static string Info()
        {
            ...
            MarkerLocationItem.title = "test";
            MarkerLocationItem.lat = 25.040282;
            MarkerLocationItem.lng = 121.511901;
            MarkerLocationItem.description = "台灣最高指揮中心";
            MarkerLocationItem.icon = "/Icon/WeatherIcon1.png";

            var json = Newtonsoft.Json.JsonConvert.SerializeObject(MarkerLocationItem);
            string result = json;
            return result;
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)//Get Method要做的事
            {
                ...
                dt.Rows.Add("政府", 25.040282, 121.511901, "台灣最高指揮中心", "/Icon/WeatherIcon1.png");
        ...
        {
            string webAddr = "http://propeople.cloudapp.net/Service1.svc/GetOpenData/1/" + Guid.NewGuid();
            ...
            {
                dt.Rows.Add(item.SiteName, item.SiteLatitude, item.SiteLongitude, item.SiteAddress, "/Icon/WeatherIcon2.png");
            }
            rptMarkers.DataSource = dt;
            rptMarkers.DataBind();
        }
        ...
        {
            string webAddr = "http://propeople.cloudapp.net/Service1.svc/GetOpenData/2/" + Guid.NewGuid();
            HttpWebRequest httpWebRequest = (HttpWebRequest)HttpWebRequest.Create(webAddr);
            httpWebRequest.ContentType = "application/json";
            httpWebRequest.Method = "GET";
            HttpWebResponse response = (HttpWebResponse)httpWebRequest.GetResponse();
            ...
            foreach (var item in GetData)
            {
                dt.Rows.Add(item.SiteName, item.SiteLatitude, item.SiteLongitude, item.SiteAddress, "/Icon/WeatherIcon1.png");
            }
            rptMarkers.DataSource = dt;
            rptMarkers.DataBind();
        }
        ...
        {
            string GetValue = TreeView1.SelectedNode.Value;
            int InsertValue;
            if (int.TryParse(GetValue, out InsertValue) == true)
            {
                if (InsertValue >= 0 && InsertValue < 9)
                {
                    //List<MarkerLocation> MarkerLocationItemList = new List<MarkerLocation>();
                    //string webAddr = "http://propeople.cloudapp.net/Service1.svc/GetOpenData/" + GetValue + "/" + Guid.NewGuid();
                    //HttpWebRequest httpWebRequest = (HttpWebRequest)HttpWebRequest.Create(webAddr);
                    //httpWebRequest.ContentType = "application/json";
                    //httpWebRequest.Method = "GET";
                    //HttpWebResponse response = (HttpWebResponse)httpWebRequest.GetResponse();
                    ...
                    //foreach (var item in GetData)
                    //{
                    //    dt.Rows.Add(item.SiteName, item.SiteLatitude, item.SiteLongitude, item.SiteAddress,"");
                    //}
                    //rptMarkers.DataSource = dt;
                    //rptMarkers.DataBind();
                ...
                else if (InsertValue == 10)
                {
                    WeatherDataParse();
                }
                else if (InsertValue == 11)
                {
                    radiationInformation();
                }
                else if (InsertValue == 12)
                {
                    UVInformation();
                }
                else if (InsertValue == 13)
                {
                    OceanDataParse();
                }
                else if(InsertValue == 14)
                {
                    AQXInformation();
                }
            }
        ...
        public void radiationInformation()
        {
            List<MarkerLocation> MarkerLocationItemList = new List<MarkerLocation>();
        ...
        {
            //DataTable dt = new DataTable();
            //dt.Columns.AddRange(new DataColumn[2] { new DataColumn("from"), new DataColumn("to") });
            //dt.Rows.Add(FormTextBox.Text, ToTextBox.Text);
            //rptRoad.DataSource = dt;
            //rptRoad.DataBind();

            directionsLocation directionsLocationItem = new directionsLocation();
            directionsLocationItem.from = FormTextBox.Text;
            directionsLocationItem.to = ToTextBox.Text;

            string json = Newtonsoft.Json.JsonConvert.SerializeObject(directionsLocationItem);
            ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "JustAlert", "GetGoogledirections('" + json + "');", true);
        ...
        protected void Menu1_MenuItemClick(object sender, MenuEventArgs e)
        {
            ...
            if (index == 0)
            {
                ...
                foreach (hazards item in hazardsListData)
                {
                    ...
                    {
                        HazardsInfo += ":" + item.hazardConditionsData.info.phenomena + item.hazardConditionsData.info.significance + " ";
        ...
        protected void TreeViewUser_SelectedNodeChanged(object sender, EventArgs e)
        {
            ...
            if (TreeToken[0] == "G")
            {
                foreach (TreeNode item in TreeViewUser.SelectedNode.ChildNodes)
                {
                    ...
                    if (string.IsNullOrEmpty(ChildTreeToken[1]) == false && string.IsNullOrEmpty(ChildTreeToken[2]) == false && string.IsNullOrEmpty(ChildTreeToken[3]) == false)
                    {
                        ...
                        MarkerLocationItem.description = item.Text;
            ...
            //MarkerLocation MarkerLocationItem1 = new MarkerLocation();
            //MarkerLocationItem1.title = "all";
            //MarkerLocationItem1.lat = 25.12345;
            //MarkerLocationItem1.lng = 121.12345;
            //MarkerLocationItem1.description = "台灣最低指揮中心";
            //MarkerLocationItem1.icon = "/Icon/people1.png";
            //MarkerLocationItemList.Add(MarkerLocationItem1);

            

            //List<MarkerLocation> MarkerLocationList = new List<MarkerLocation>();
            //string GetValue =  TreeViewUser.SelectedNode.Value;
            //int InsertValue;
            //if (int.TryParse(GetValue, out InsertValue) == true)
            //{
            ...
            //    {
            //        MarkerLocation MarkerLocationItem = new MarkerLocation();
            //        MarkerLocationItem.title = InsertValue.ToString();
            //        MarkerLocationItem.lat = 24.181722;
            //        MarkerLocationItem.lng = 121.281378;
            //        MarkerLocationItem.description = TreeViewUser.SelectedNode.Text;
            //        MarkerLocationItem.icon = "/Icon/people1.png";
            //        MarkerLocationList.Add(MarkerLocationItem);
            //    }
            //    else if (InsertValue == 1)
            //    {
            //        MarkerLocation MarkerLocationItem = new MarkerLocation();
            //        MarkerLocationItem.title = InsertValue.ToString();
            //        MarkerLocationItem.lat = 23.474284;
            //        MarkerLocationItem.lng = 120.451093;
            //        MarkerLocationItem.description = TreeViewUser.SelectedNode.Text;
            //        MarkerLocationItem.icon = "/Icon/people1.png";
            //        MarkerLocationList.Add(MarkerLocationItem);
            //    }
            ...
            //        MarkerLocation MarkerLocationItem = new MarkerLocation();
            //        MarkerLocationItem.title = InsertValue.ToString();
            //        MarkerLocationItem.lat = 21.948351;
            //        MarkerLocationItem.lng = 120.779752;
            //        MarkerLocationItem.description = TreeViewUser.SelectedNode.Text;
            //        MarkerLocationItem.icon = "/Icon/people1.png";
            //        MarkerLocationList.Add(MarkerLocationItem);
            //    }
            ...
            //        MarkerLocation MarkerLocationItem = new MarkerLocation();
            //        MarkerLocationItem.title = InsertValue.ToString();
            //        MarkerLocationItem.lat = 24.030805;
            //        MarkerLocationItem.lng = 121.629552;
            //        MarkerLocationItem.description = TreeViewUser.SelectedNode.Text;
            //        MarkerLocationItem.icon = "/Icon/people1.png";
            //        MarkerLocationList.Add(MarkerLocationItem);
            //    }
            //    else if (InsertValue == 4)
            //    {
            //        MarkerLocation MarkerLocationItem = new MarkerLocation();
            //        MarkerLocationItem.title = InsertValue.ToString();
            //        MarkerLocationItem.lat = 25.194256;
            //        MarkerLocationItem.lng = 121.560925;
            //        MarkerLocationItem.description = TreeViewUser.SelectedNode.Text;
            //        MarkerLocationItem.icon = "/Icon/people1.png";
            //        MarkerLocationList.Add(MarkerLocationItem);
            //    }
            //    else if (InsertValue == 5)
            //    {
            //        MarkerLocation MarkerLocationItem = new MarkerLocation();
            //        MarkerLocationItem.title = InsertValue.ToString();
            //        MarkerLocationItem.lat = 24.203549;
            //        MarkerLocationItem.lng = 120.812670;
            //        MarkerLocationItem.description = TreeViewUser.SelectedNode.Text;
            //        MarkerLocationItem.icon = "/Icon/people1.png";
            //        MarkerLocationList.Add(MarkerLocationItem);
            //    }
            //    else if (InsertValue == 6)
            //    {
            //        MarkerLocation MarkerLocationItem = new MarkerLocation();
            //        MarkerLocationItem.title = InsertValue.ToString();
            //        MarkerLocationItem.lat = 22.594819;
            //        MarkerLocationItem.lng = 120.306951;
            //        MarkerLocationItem.description = TreeViewUser.SelectedNode.Text;
            //        MarkerLocationItem.icon = "/Icon/people1.png";
            //        MarkerLocationList.Add(MarkerLocationItem);
            //    }
            ...
            //        foreach (TreeNode item in TreeViewUser.SelectedNode.ChildNodes)
            //        {
            //            string ChildValue = item.Value;
            //            int ChildInsertValue;
            //            if (int.TryParse(ChildValue, out ChildInsertValue) == true)
            //            {
            //                if (ChildInsertValue == 0)
            //                {
            //                    MarkerLocation MarkerLocationItem = new MarkerLocation();
            //                    MarkerLocationItem.title = InsertValue.ToString();
            //                    MarkerLocationItem.lat = 24.181722;
            ...
            //    }
            //}
            //if (MarkerLocationList.Count() != 0)
            //{
            //    UserLocation(MarkerLocationList);
            //}
        }

        public void UserLocation(List<MarkerLocation> MarkerLocationList)
        {
            DataTable dt = new DataTable();
            dt.Columns.AddRange(new DataColumn[5] { new DataColumn("title"), new DataColumn("lat"), new DataColumn("lng"), new DataColumn("description"), new DataColumn("icon") });
            foreach (var item in MarkerLocationList)
            {
                dt.Rows.Add(item.title, item.lat, item.lng, item.description, item.icon);
            }
            rptMarkers.DataSource = dt;
            rptMarkers.DataBind();
        }
        ...
        protected void LoginButton_Click(object sender, EventArgs e)
        {
            ...
            {
                string webAddr = "http://propeople.cloudapp.net/Service1.svc/Login/" + UserNameText.Text + "/" + PasswordText.Text + "/" + Guid.NewGuid();
                HttpWebRequest httpWebRequest = (HttpWebRequest)HttpWebRequest.Create(webAddr);
                httpWebRequest.ContentType = "application/json";
                httpWebRequest.Method = "GET";
                HttpWebResponse response = (HttpWebResponse)httpWebRequest.GetResponse();
                ...
                {
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Message", "alert('登入成功')", true);
                    RegisterLabel.Text = "Hello " + UserNameText.Text;
                    Session["UserID"] = InsertValue;
                    TreeViewGet(Session["UserID"].ToString());
                }
                else
                {
            ...
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Message", "alert('請輸入帳號密碼')", true);
                //Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "Message", "<script>alert('請輸入帳號密碼');</script>");
            }
        }
        ...
        public void TreeViewGet(string UserID)
        {
            ...
            {
                string webAddr = "http://propeople.cloudapp.net/Service1.svc/GetGroupInfo/" + UserID + "/" + Guid.NewGuid();
                HttpWebRequest httpWebRequest = (HttpWebRequest)HttpWebRequest.Create(webAddr);
                httpWebRequest.ContentType = "application/json";
                httpWebRequest.Method = "GET";
                HttpWebResponse response = (HttpWebResponse)httpWebRequest.GetResponse();
                ...
                List<GroupInfo> GetData = obj.ReadObject(resStream) as List<GroupInfo>;

                TreeViewUser.Nodes.Clear();
                foreach (var item in GetData)
                {
                    TreeNode GroupNode = new TreeNode();
                    GroupNode.Text = item.GroupName;
                    GroupNode.Value = "G_" + item.GroupID;
                    foreach (var items in item.GroupUser)
                    {
        ...
        protected void RegisterButton_Click(object sender, EventArgs e)
        {
            if (string.IsNullOrEmpty(UserNameText.Text) == false && string.IsNullOrEmpty(PasswordText.Text) == false)
            {
                ...
                UserInformationItem.UserName = UserNameText.Text;
                UserInformationItem.UserPassword = PasswordText.Text;

                string webAddr = "http://propeople.cloudapp.net/Service1.svc/UserRegister";
                HttpWebRequest httpWebRequest = (HttpWebRequest)HttpWebRequest.Create(webAddr);
                httpWebRequest.ContentType = "application/json";
        ...
        {
            if (Session["UserID"] != null && string.IsNullOrEmpty(GroupCreate.Text) == false)
            {
                string webAddr = "http://propeople.cloudapp.net/Service1.svc/CreateGroup/" + Session["UserID"].ToString() + "/" + GroupCreate.Text + "/" + Guid.NewGuid();
                HttpWebRequest httpWebRequest = (HttpWebRequest)HttpWebRequest.Create(webAddr);
                httpWebRequest.ContentType = "application/json";
                httpWebRequest.Method = "GET";
                HttpWebResponse response = (HttpWebResponse)httpWebRequest.GetResponse();
        ...
        {
            if (Session["UserID"] != null && string.IsNullOrEmpty(GroupID.Text) == false)
            {
                string webAddr = "http://propeople.cloudapp.net/Service1.svc/JoinGroup/" + Session["UserID"].ToString() + "/" + GroupID.Text + "/" + Guid.NewGuid();
                HttpWebRequest httpWebRequest = (HttpWebRequest)HttpWebRequest.Create(webAddr);
                httpWebRequest.ContentType = "application/json";
                httpWebRequest.Method = "GET";
                HttpWebResponse response = (HttpWebResponse)httpWebRequest.GetResponse();
        ...
        protected void Timer1_Tick(object sender, EventArgs e)
        {
                ...
                TreeNode GroupNode = new TreeNode();
                GroupNode.Text = "test";
                GroupNode.Value = "test"; ;

                TreeViewUser.Nodes.Add(GroupNode);
        }

        protected void AddGroup_Click1(object sender, EventArgs e)
        {
            DataTable dt = new DataTable();
            dt.Columns.AddRange(new DataColumn[5] { new DataColumn("title"), new DataColumn("lat"), new DataColumn("lng"), new DataColumn("description"), new DataColumn("icon") });
            dt.Rows.Add("政府", 25.040282, 121.511901, "台灣最高指揮中心", "/Icon/WeatherIcon1.png");
            ...
            ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "JustAlert", "pmValidateGLAccount();", true);
            //ClientScript.RegisterStartupScript(this.GetType(), "", "<script language='javascript'>GetGoogleMap();</script>"); 
        }

        protected void Button1_Click2(object sender, EventArgs e)
        {
            Session["lat"] = 25.040282;
            Session["lng"] = 25.040282;
            ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "JustAlert", "pmValidateGLAccount();", true);
        }
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            string json = Newtonsoft.Json.JsonConvert.SerializeObject(MarkerLocationItem);
            //ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "JustAlert", "GetGoogleMap('" + json + "');", true);
            ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "JustAlert", "SearchLocation('" + json + "');", true);
        }

        protected void AddGroup_Click2(object sender, EventArgs e)
        {
            ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "JustAlert", "SearchLocation('23.7758434,120.5254325');", true);
        }
        ...
        protected void TreeTimer_Tick(object sender, EventArgs e)
        {
            ...
            {
                TreeViewGet(Session["UserID"].ToString());
                GetMessage(Session["UserID"].ToString());
            }
        }

        public void GetMessage(string UserID)
        {
            string webAddr = "http://propeople.cloudapp.net/Service1.svc/GetMessageInfo/" + UserID + "/0/" + Guid.NewGuid();
            HttpWebRequest httpWebRequest = (HttpWebRequest)HttpWebRequest.Create(webAddr);
            httpWebRequest.ContentType = "application/json";
            httpWebRequest.Method = "GET";
            HttpWebResponse response = (HttpWebResponse)httpWebRequest.GetResponse();
            ...
            List<MessageInfo> GetData = obj.ReadObject(resStream) as List<MessageInfo>;
            foreach (var item in GetData)
            {
                foreach(var items in item.MessageGroup)
                {
                    string Message = "["+item.Time +"](" + items.GroupName + ")" + item.UserName + ":" + item.Content;
        ...
        protected void SendButton_Click(object sender, EventArgs e)
        {
            ...
            if (Session["UserID"] == null)
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Message", "alert('尚未登入帳號')", true);
            }
            //
        }
